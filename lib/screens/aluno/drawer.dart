    ...
    return Drawer(
      ...
      child: Column(
        children: [
          ...
          Center(child: Text("Ornácio", style: Theme.of(context).textTheme.displayMedium)),
          Center(child: Text("R\$ 20,00", style: Theme.of(context).textTheme.displaySmall)),
          const SizedBox(height: 50),
          Center(child: Text("Mensagens", style: Theme.of(context).textTheme.headlineMedium)),
          Expanded(
            child: Container(
              color: Colors.grey,
